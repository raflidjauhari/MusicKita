...
public class MainActivity extends AppCompatActivity {
    private BottomNavigationView bnvMusicKita;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bnvMusicKita.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            @Override
    ...
    private void initView(){
        bnvMusicKita = findViewById(R.id.bnv_musik_kita);
